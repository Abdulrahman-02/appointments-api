...
module.exports = {
    ...
    getAppointmentById: async function (req, res) {
        // code to get a single appointment by ID
        try {
    ...
    updateAppointmentById: async function (req, res) {
        // code to update a single appointment by ID
        try {
            const appointmentRef = await db.collection('appointments').doc(req.params.id).get();
            const appointment = appointmentRef.data();
    ...
    deleteAppointmentById: async function (req, res) {
        // code to delete a single appointment by ID
